                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('UserController@store') }}"
                              aria-label="{{ __('users/create.register') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-suggest-password" data-toggle="modal"
                                            data-target="#pwdModal">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                                             height="18" style="vertical-align: middle;">
                                            <path d="M18,9H17V7c0-2.8-2.2-5-5-5S7,4.2,7,7v2H6c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V11C20,9.9,19.1,9,18,9z M9,7 c0-1.7,1.3-3,3-3s3,1.3,3,3v2H9V7z M19,21H5V11h14V21z"
                                                  fill="gold"/>
                                            <path d="M12.5,15.5c0.3,0,0.5-0.1,0.7-0.3l1.4-1.4c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-0.6,0.6V12c0-0.6-0.4-1-1-1s-1,0.4-1,1v1.9l-0.6-0.6 c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l1.4,1.4c0.2,0.2,0.4,0.3,0.7,0.3S12.3,15.7,12.5,15.5z"
                                                  fill="gold"/>
                                            <path d="M11.5,13.5h1v1h-1V13.5z M12,14.2c0.1,0,0.2-0.1,0.3-0.1v-0.6h-0.6c0,0.1,0.1,0.2,0.1,0.3C11.8,13.7,11.9,14.2,12,14.2z"
                                                  fill="black"/>
                                        </svg>
