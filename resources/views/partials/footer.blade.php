    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
            ...
            <p class="max-w-xs mt-4 text-sm text-gray-600">
                Hosted, interactive, self-reflective AutoGPT in your browser. An intelligent terminal just for you.
            </p>
            <div class="flex mt-8 space-x-6 text-gray-600">
                ...
                <a class="hover:opacity-75" href="https://github.com/tvup/kuber-gpt-web-gui" target="_blank" rel="noreferrer">
