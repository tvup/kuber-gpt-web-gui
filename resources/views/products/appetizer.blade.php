    ...
    <main id="main-container">
        <div class="bg-image" style="background-image: url('/media/photos/photo3@2x.jpg');">
            <div class="bg-primary-dark-op">
                ...
                <h6 class="text-black-75 text-right"><a href="{{ route('its-free') }}">{{__('products.psst_if_you_are_the_type_who_can_also_spend_day_in_and_day_out_then_maybe_you_should_just_put_the_payment_card_away_and_click_here')}}</a></h6>
            </div>
